...
<head>
    ...
    <title>Download Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo in SVG Vector or PNG File Format - Logo.wine</title>
    <link rel="canonical" href="https://www.logo.wine/logo/Outlook.com">
    <link rel="amphtml" href="https://www.logo.wine/amp/logo/Outlook.com">
...
<script type="application/ld+json">
{
 ...
 "@type": "WebPage",
 "url": "https://www.logo.wine/logo/Outlook.com",
 "name": "www.logo.wine",
 "headline": "Download Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo in SVG Vector or PNG File Format",
 "description": "Download from here the authentic and quality Outlook.com (MSN Hotmail, Windows Live Hotmail) logo in SVG vector or PNG file format.",
 "mainEntityOfPage": {
  "@type": "WebPage",
 ...
 "image": {
  "@type": "ImageObject",
  "contentUrl": "https://www.logo.wine/a/logo/Outlook.com/Outlook.com-Logo.wine.svg",
  "description": "Transparent Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo in SVG vector format",
  "name": "Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo SVG",
  "width": 1200,
  "height": 800
 }
}
...
</script><script type="application/ld+json">
{
 "@context": "http://schema.org",
 "@type": "ImageObject",
 "contentUrl": "https://download.logo.wine/logo/Outlook.com/Outlook.com-Logo.wine.png",
 "description": "High Resolution Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo symbol in PNG format",
 "name": "Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo PNG",
 "width": 3000,
 "height": 2000
}
</script>
    <meta name="description" content="Download from here the authentic and quality Outlook.com (MSN Hotmail, Windows Live Hotmail) logo in SVG vector or PNG file format.">
...
.About{border-bottom:1px solid rgba(55, 71, 79, 0.15);padding-bottom:10px;font-size:17px}.About-Title{font-size:30px;font-weight:400;color:#444;max-width:1000px;margin:0 auto;width:100%;padding:1em 30px 1em}@media screen and (max-width: 1000px){.About-Title{font-size:28px;padding-left:30px;padding-right:30px}}@media screen and (max-width: 600px){.About-Title{font-size:24px;padding-top:1em;padding-bottom:.5em;padding-left:20px;padding-right:20px}}.About p{max-width:1000px;margin:0 auto 1em}@media screen and (max-width: 1060px){.About p{margin:0 0 1em;padding-left:30px;padding-right:30px}}@media screen and (max-width: 600px){.About p{margin:0 0 1em;padding-left:20px;padding-right:20px}}.About a{color:inherit;-webkit-tap-highlight-color:transparent}.About .article-img{width:100%;height:auto;display:block;margin:2em auto;max-width:1000px}@media screen and (max-width: 1000px){.About .article-img{max-width:100vw}}.About .yt{display:block;margin:2em auto;max-width:600px}@media screen and (max-width: 600px){.About .yt{max-width:100vw}}
...
<main class="Main ">
    <article>
        <header class="Title ">
            <h1>Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo Download</h1>
            <p>
                Download for free the <strong>Outlook.com (MSN Hotmail, Windows Live Hotmail)</strong> logo in vector (SVG) or PNG file format.
            </p>
        </header>
        ...
        <div data-template class="LogoPopUp LogoBlock ">
            <div data-ts="backgroundColor" class="LogoBlock-Wrapper ">
                <div data-ts="backgroundColor" class="LogoBlock-Logo ">
                    <img data-t="width,height,src:svgImgPath,alt" width="1200" height="800" src="/a/logo/Outlook.com/Outlook.com-Logo.wine.svg" alt="Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo">
                </div>
            </div>
            <div class="LogoBlock-Buttons ">
                <div class="LogoButtons ">
                    <div class="LogoButton LogoButton_svg ">
                        <a data-t="href:svgPath" download target="_blank" rel="noopener" href="/a/logo/Outlook.com/Outlook.com-Logo.wine.svg" title="Download Transparent Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo in SVG vector format">
                            Download SVG Logo
                        </a>
                    </div>
                        <div class="LogoButton LogoButton_png ">
                        <a data-t="href:pngPath" target="_blank" rel="noopener" href="https://download.logo.wine/logo/Outlook.com/Outlook.com-Logo.wine.png" title="Download High Resolution Outlook.com (MSN Hotmail, Windows Live Hotmail) Logo symbol in PNG format">
                            Download PNG Logo
                        </a>
                    </div>
                </div>
                <p class="LogoBlock-Terms ">
                    By downloading the Outlook.com (MSN Hotmail, Windows Live Hotmail) logo you agree to the <a href="/terms">Terms of Use</a>.
                </p>
    ...
    <article class="About ">
    <h2 class="About-Title ">About Outlook.com (MSN Hotmail, Windows Live Hotmail)</h2>
    <p>Outlook.com was first founded in 1996 by Sabeer Bhatia and Jack Smith as Hotmail and was acquired by <a href="https://www.microsoft.com/" target="_blank" rel="noopener noreferrer">Microsoft</a> in 1997. It was introduced as Outlook.com in 2012, when its beta version was made available to the general public.</p>
<p>Outlook.com is a personal information manager online app from Microsoft which includes webmail, calendaring, contacts, and tasks services. By May 2013, Outlook.com had 400 million active users.</p>
<p>Some of the features of the app are: keyboard controls, searching the user's messages including message filters, folder-based organization of messages, auto-completion of contact addresses, contact grouping, importing and exporting of contacts, text formatting, text signatures, spam filtering and virus scanning, support for multiple addresses, and different language versions.</p>
<p>For additional information or signing up, visit their official website: <a href="https://outlook.live.com/owa/" target="_blank" rel="noopener noreferrer">outlook.live.com</a> or download the app from the <a href="https://apps.apple.com/us/app/microsoft-outlook/id951937596" target="_blank" rel="noopener noreferrer">App Store</a> or <a href="https://play.google.com/store/apps/details?id=com.microsoft.office.outlook&hl=en_US" target="_blank" rel="noopener noreferrer">Google Play</a>.</p>
</article>
    
    <div class="Related ">
        <div class="Related-Container ">
            <div class="BoxLink ">
                    <a href="/logo/Outlook_Mobile">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Outlook_Mobile/Outlook_Mobile-Logo.wine.svg" alt="Outlook Mobile (Acompli) Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Outlook Mobile</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Yammer">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Yammer/Yammer-Logo.wine.svg" alt="Yammer Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Yammer</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/OneDrive">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/OneDrive/OneDrive-Logo.wine.svg" alt="Microsoft OneDrive Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Microsoft OneDrive</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Microsoft_Outlook">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Microsoft_Outlook/Microsoft_Outlook-Logo.wine.svg" alt="Microsoft Outlook Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Microsoft Outlook</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/GitHub">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/GitHub/GitHub-Logo.wine.svg" alt="GitHub Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">GitHub</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Mixer_(service)">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Mixer_(service)/Mixer_(service)-Logo.wine.svg" alt="Mixer (Beam) Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Mixer</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Xamarin">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Xamarin/Xamarin-Logo.wine.svg" alt="Xamarin Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Xamarin</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Office_Online">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Office_Online/Office_Online-Logo.wine.svg" alt="Office Online (Office Web Apps) Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Office Online</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Microsoft_Office">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Microsoft_Office/Microsoft_Office-Logo.wine.svg" alt="Microsoft Office Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Microsoft Office</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Gmail">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Gmail/Gmail-Logo.wine.svg" alt="Gmail Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Gmail</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Office_365">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Office_365/Office_365-Logo.wine.svg" alt="Office 365 Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Office 365</h4>
                    </a>
                </div><div class="BoxLink ">
                    <a href="/logo/Microsoft_Word">
                        <div class="BoxLink-Logo ">
                            <img width="1200" height="800" src="/a/logo/Microsoft_Word/Microsoft_Word-Logo.wine.svg" alt="Microsoft Word (Multi-Tool Word) Logo" loading="lazy">
                        </div>
                        <h4 class="BoxLink-Title ">Microsoft Word</h4>
                    </a>
                </div>
        </div>
    </div>
...
<footer class="Footer ">
    <div class="Footer-Content ">
        <div class="Footer-Menu ">
            ...
            <div class="Policy ">
                <p>The content of this site is provided on an “as-is” and “as available” basis, and it is intended for non-commercial, informational purposes only, to educate and inform its website visitors about the Outlook.com logo.</p>
                <p>A third party person or company should never use the Outlook.com logo without the written permission of the copyright and/or trademark holder. For any usage of Outlook.com logo and brand elements, please contact Outlook.com directly to request a licensing agreement.</p>
                <p>By downloading the Outlook.com logo from Logo.wine you hereby acknowledge that you agree to these Terms of Use and that the artwork you download could include technical, typographical, or photographic errors. Logo.wine does not warrant that any of the materials on its website are accurate, complete or current.</p>
...
(function() {
    ...
    function m() {
        ...
        setTimeout(function() {
            ...
            gtag('config', 'UA-152740724-1', { 'anonymize_ip': true });
            
            $loadjs("https://www.googletagmanager.com/gtag/js?id=UA-152740724-1");
        }, 100);
    }
